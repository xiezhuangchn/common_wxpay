...
public class WxPayConstants {
   ...
   * 拉取订单评价数据接口的参数中日期格式.
   */
  public static final Format QUERY_COMMENT_DATE_FORMAT = FastDateFormat
   ...
   * 分账状态
   */
  public static class ShareAccountStatus {

    /*
    分账单状态: ACCEPTED—受理成功 PROCESSING—处理中 FINISHED—处理完成 CLOSED—处理失败，已关单
     */
