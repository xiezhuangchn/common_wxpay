...
import com.hnair.pay.agent.weixin.exception.WxErrorException;
import com.hnair.pay.agent.weixin.exception.WxPayException;
import com.hnair.pay.agent.weixin.utils.BeanUtils;
...
public abstract class BaseWxPayRequest implements Serializable {
   ...
   */
  public void checkAndSign(WxBaseConfig config) throws WxPayException {
    this.checkFields();
