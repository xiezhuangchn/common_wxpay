...
public class WxPayDownloadBillRequest extends BaseWxPayRequest {
  private static final String[] BILL_TYPES = new String[]{WxPayConstants.BillType.ALL,
          WxPayConstants.BillType.SUCCESS, WxPayConstants.BillType.REFUND, WxPayConstants.BillType.RECHARGE_REFUND};
